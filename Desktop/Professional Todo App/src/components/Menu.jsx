...
const Menu = ({ onClose }) => {
  ...
  return (
    <div className='bg-gray-100 max-h-screen min-h-[1000px] rounded-2xl p-6 w-[350px]'>
      <h2 className='font-bold text-2xl flex items-center cursor-pointer justify-between'>
      ...
      <div className='mt-2 text-gray-600 space-y-3 font-semibold'>
        ...
        <div className='flex items-center justify-between hover:bg-gray-200 p-2 rounded-md'>
          ...
          <span className="text-xs bg-gray-200 px-2 py-1 rounded"> 10 {/* There will dynamic value */}</span>
        </div>

        <div className='flex items-center justify-between hover:bg-gray-200 p-2 rounded-md'>
          <p className='flex items-center gap-2'><List />Today </p>
          <span className="text-xs bg-gray-200 px-2 py-1 rounded"> 5 {/* There will dynamic value */}</span>
        </div>
